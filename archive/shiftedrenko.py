...
class shiftedrenko:
    ...
    def set_brick_size(self, brick_size=8.0, shift_pct=0.125):
        self.brick_size = brick_size
        self.shift_size = brick_size * shift_pct
        self.divisions = brick_size / self.shift_size
        return self.brick_size, self.shift_size, self.divisions
    ...
    def plot_renko(self, col_up='g', col_down='r'):
        ...
        for i in range(1, len(self.renko_prices)):
            ...
            # ax.scatter([x], [self.renko_prices[i]])
